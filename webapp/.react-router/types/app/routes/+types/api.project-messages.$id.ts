...
type Module = typeof import("../api.project-messages.$id.js")

type Info = GetInfo<{
  file: "routes/api.project-messages.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.project-messages.js");
}, {
  id: "routes/api.project-messages.$id";
  module: typeof import("../api.project-messages.$id.js");
}];
