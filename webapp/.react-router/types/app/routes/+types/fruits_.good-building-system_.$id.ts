...
type Module = typeof import("../fruits_.good-building-system_.$id.js")

type Info = GetInfo<{
  file: "routes/fruits_.good-building-system_.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../fruits_.good-building-system_.$id.js");
}];
