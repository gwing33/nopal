...
type Module = typeof import("../api.building-system.categories.$id.js")

type Info = GetInfo<{
  file: "routes/api.building-system.categories.$id.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../api.building-system.categories.js");
}, {
  id: "routes/api.building-system.categories.$id";
  module: typeof import("../api.building-system.categories.$id.js");
}];
