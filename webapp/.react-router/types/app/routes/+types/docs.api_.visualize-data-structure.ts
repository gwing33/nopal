...
type Module = typeof import("../docs.api_.visualize-data-structure.js")

type Info = GetInfo<{
  file: "routes/docs.api_.visualize-data-structure.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../docs.api_.visualize-data-structure.js");
}];
