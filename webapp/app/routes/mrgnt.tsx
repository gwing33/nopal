      ...
      <div className="notions">
        <div>
          <div className="notions-box">
            <ul>
              <li>
                <a className="link">+Presentation</a>
              </li>
              <li>
        ...
        <div className="md-content">
          <div className="mdmdmdmdmdmdmdmd">
            A lot of goals, clocks rewind. Some fall to action, others need
            time. Below a list, thoughts of mind. Enjoy the process, as will
            mine.
            <h1># Goal</h1>
            <p>
              The purpose of this site is singularly focused on organization.
              How can we better organize our thoughts, process, tasks, or
              documentation? How can we organize these such that others get
              looped in at the right time? How can it be simple and quick no
              matter the modality?
            </p>
            <h2>## Organization</h2>
            <p>
            ...
            <p>
              Facts are simply part of a story, they are needed to make the
              story.
            </p>
            <h2>## Story</h2>
            <p>
            ...
            <h2>## Fin</h2>
            <p>
              In the end, the more thoughts we can capture and organize, the
              more interesting our story is.
            </p>
          </div>
          <div className="annotations">
            ...
            >
              ...
              so big. So you can't just keep on writing as you run out of
              physical space. It's absurd quite frankly. If you have a thought
              that takes up an entire page, fine. Turn. The. Page. Seriously.
              Turn it.
            </div>
          </div>
        </div>
